...
from tensorflow.keras.layers import Embedding, LSTM,Dense, GRU, SpatialDropout1D, Dropout
...
embedding_dict={}
file_name = "data/glove.twitter.27B.200d.txt"
...
with tf.device('/job:localhost/replica:0/task:0/device:GPU:0'):
    ...
    model.save('glove_lstm_model_200d.h5')